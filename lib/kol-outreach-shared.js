...
export const KOL_BOARD_PROP = {
  ...
  /** Follow-up outreach card on same KOL + initiative (round 2+). */
  outreachRound: 'prop_outreach_round',
  parentOutreachTaskId: 'prop_parent_outreach_task_id',
};
...
export function defaultKolOutreachCustomProperties() {
  return [
    ...
    { id: KOL_BOARD_PROP.outreachRound, type: 'text', label: 'Outreach round' },
    { id: KOL_BOARD_PROP.parentOutreachTaskId, type: 'text', label: 'Parent outreach task' },
  ];
}
