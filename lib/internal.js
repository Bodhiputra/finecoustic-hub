...
import { knowledgeBankUrl } from '@/lib/knowledge';
...
export const DEPARTMENTS = [
  ...
  },
  {
    ...
    taskNav: {
      type: 'campaigns',
      toolId: 'campaigns',
      href: '/marketing?tool=campaigns',
      sectionLabelKey: 'hub.internal.sectionCampaignList',
      labelKey: 'hub.internal.campaignList',
    },
    dataLinks: [
      {
        id: 'preorder-survey',
...
export function getAboutFinecousticLandingPath() {
  return knowledgeBankUrl(ABOUT_FINEACOUSTIC.path);
}
...
/** Sidebar task section — standard dept tasks and/or campaign list (Marketing). */
