...
export function getAboutFinecousticLandingPath() {
  return finecousticWikiUrl(ABOUT_FINEACOUSTIC.path);
}
...
export function isUnscheduledCalendarItem(task) {
  ...
  if (task.kind === 'milestone') return !task.deadline && !task.planned_for;
...
export function internalTasksUrl(basePath, { view = '', people = null } = {}) {
