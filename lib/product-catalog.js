...
export const PRODUCT_CATALOG_VERSION = 5;

export const FINEACOUSTIC_PRODUCT_CATALOG = [
  {
    sku: 'FBS1',
    name: 'Hako Nomad FBS1',
...
- USB-C · 3.5 mm TRS · 2.4 GHz wireless`,
  ...
  {
    sku: 'FBB301W',
    name: 'Hako Studio FBB301 - 白色',
    price_display: 'TBD',
    status: 'npd',
    sort_order: 7,
    description:
      'Hako Studio 301 bookshelf speaker — White finish. Desk / WFH / small listening spaces. Launch preparation — KOL gifting.',
    image_url: '',
    specs: {
      md: `## Overview
**Hako Studio 301 - White** (FBB301W) — bookshelf speaker for desk setup, room/TV, music lovers, and video editors.`,
    },
  },
  {
    sku: 'FBB301B',
    name: 'Hako Studio FBB301 - 黑色',
    price_display: 'TBD',
    status: 'npd',
    sort_order: 8,
    description:
      'Hako Studio 301 bookshelf speaker — Black finish. Desk / WFH / small listening spaces. Launch preparation — KOL gifting.',
    image_url: '',
    specs: {
      md: `## Overview
**Hako Studio 301 - Black** (FBB301B) — bookshelf speaker for desk setup, room/TV, music lovers, and video editors.`,
    },
  },
  {
    sku: 'FBB302W',
    name: 'Hako Studio FBB302 - 白色',
    price_display: 'TBD',
    status: 'npd',
    sort_order: 9,
    description:
      'Hako Studio 302 bookshelf speaker — White finish. Launch preparation — KOL gifting alongside Studio 301.',
    image_url: '',
    specs: {
      md: `## Overview
**Hako Studio 302 - White** (FBB302W) — companion variant in the Hako Studio bookshelf line.`,
    },
  },
  {
    sku: 'FBB302B',
    name: 'Hako Studio FBB302 - 黑色',
    price_display: 'TBD',
    status: 'npd',
    sort_order: 10,
    description:
      'Hako Studio 302 bookshelf speaker — Black finish. Launch preparation — KOL gifting alongside Studio 301.',
    image_url: '',
    specs: {
      md: `## Overview
**Hako Studio 302 - Black** (FBB302B) — companion variant in the Hako Studio bookshelf line.`,
    },
  },
];
