...
export const RETIRED_PRODUCT_SKUS = [];

/** Bump when catalog entries change — triggers one-time re-sync. */
export const PRODUCT_CATALOG_VERSION = 3;
...
- USB-C · 3.5 mm TRS · 2.4 GHz wireless`,
  ...
  {
    sku: 'FBB301',
    name: 'Hako Studio 301',
    price_display: 'TBD',
    status: 'npd',
    sort_order: 7,
    description:
      'Compact bookshelf / desktop speaker for desk setups, WFH, and small listening spaces. Launch preparation — primary KOL gifting SKU for Studio line.',
    image_url: '',
    specs: {
      md: `## Overview
**Hako Studio 301** (FBB301) — bookshelf speaker for desk setup, room/TV, music lovers, and video editors.

## Launch
Pre-launch / KOL seeding — update store URL and hero image when Shopify listing is live.`,
    },
  },
  {
    sku: 'FBB302',
    name: 'Hako Studio 302',
    price_display: 'TBD',
    status: 'npd',
    sort_order: 8,
    description:
      'Studio line bookshelf speaker variant (302). Launch preparation — KOL gifting alongside Hako Studio 301.',
    image_url: '',
    specs: {
      md: `## Overview
**Hako Studio 302** (FBB302) — companion variant in the Hako Studio bookshelf line.
